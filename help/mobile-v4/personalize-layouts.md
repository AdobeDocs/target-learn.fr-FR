...
Il est maintenant temps de tout rassembler et de créer des expériences personnalisées. Une _Activité_ est le [!DNL Target] mécanisme qui relie les emplacements, les audiences et les offres ensemble, de sorte que lorsque la demande est envoyée à partir de l’application, elle [!DNL Target] répond au contenu personnalisé. Nous allons créer deux activités de personnalisation dans [!DNL Target] et valider que le contenu personnalisé s’affiche à l’utilisateur approprié au bon moment et au bon endroit.

## Objectifs d&#39;apprentissage

À la fin de cette leçon, vous pourrez :

* Créer des Activités dans l&#39;Adobe Target
...
Dans l’ [!DNL Target] interface, procédez comme suit :

1. Sélectionnez **[!UICONTROL Activités]** > **[!UICONTROL Créer une Activité]** > Ciblage d’ **[!UICONTROL expérience]**.

   ![Créer une Activité](assets/activity_create_1.jpg)

1. Cliquez sur Application **** mobile.
1. Sélectionnez le compositeur **[!UICONTROL de]** formulaire.
...
1. Sélectionnez l’ **[!UICONTROL ellipse]** > **[!UICONTROL Modifier l’Audience]**.
...
1. Sélectionnez **[!UICONTROL Accueil : Susciter l’offre des nouveaux utilisateurs]** .
...
1. Sélectionnez la **[!UICONTROL recherche : Susciter l’offre des nouveaux utilisateurs]** .
1. Cliquez sur **[!UICONTROL Terminé]**.
...
1. Sélectionnez l’Audience **[!UICONTROL renvoyant des utilisateurs]** d’applications mobiles.
1. Sélectionnez **[!UICONTROL Terminé]**.
...
1. Utilisez les paramètres par défaut pour le ciblage. Si des expériences pour des audiences qui se chevauchaient (par exemple Utilisateurs _de_ New York et Utilisateurs _de_ première fois), vous pouvez classer l’ordre de priorité dans cet écran.
1. Cliquez sur **[!UICONTROL Suivant]** pour passer aux **[!UICONTROL Objectifs et paramètres]**.
...
À l’étape Objectifs et paramètres, nous allons remplacer l’objectif Principal par l’emplacement sur l’écran de confirmation de réservation :

1. Sous Paramètres **[!UICONTROL du]** Rapports, définissez l’objectif **[!UICONTROL du]** Principal sur **[!UICONTROL Conversion]**.
...
Sélectionnez **[!UICONTROL San Jose]** comme **[!UICONTROL Départ]** et **[!UICONTROL San Diego]** comme **[!UICONTROL Destination et cliquez sur Rechercher un bus pour rechercher les bus disponibles.]******

Dans l’écran des résultats, le message _Utiliser les filtres_ s’affiche. Si vous êtes un utilisateur récurrent avec 5 lancements d’application ou plus, aucun message n’apparaît ici puisque le contenu par défaut est défini pour cet emplacement (vide) :
...
Comme San Diego a été sélectionné comme destination, vous devriez voir la bannière d&#39;offre _DJ SAM_ sur l&#39;écran de confirmation :
...
Félicitations ! Ceci termine la partie principale du Adobe Target SDK 4.x pour Android Tutorial. Vous disposez désormais des compétences nécessaires pour mettre en oeuvre la personnalisation dans les applications Android ! Vous pouvez vous référer à cette documentation et à cette application de démonstration comme référence pour vos futurs projets.

Suivant : Le marquage des fonctionnalités est une autre fonctionnalité qui peut être implémentée avec l’Adobe Target dans Android. Pour en savoir plus sur le marquage des fonctionnalités, consultez la leçon suivante.
