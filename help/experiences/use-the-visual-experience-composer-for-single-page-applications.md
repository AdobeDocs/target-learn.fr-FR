...
# Utilisation du [!UICONTROL compositeur d’expérience visuelle] pour les applications monopages (SPA VEC) dans Adobe Target
...
* [Documentation du compositeur d’expérience visuelle pour application monopage (SPA)](https://experienceleague.adobe.com/docs/target/using/experiences/spa-visual-experience-composer.html?lang=en)
